  ...
  <div class="control-panel">
    <div class="control-panel__container">
      ...
      <ul class="control-panel__list">
        ...
        <li class="control-panel__list-item">
          <a class="control-panel__list-link control-panel__list-link--active" href="<?=HOST?>admin/categories">
            <div class="control-panel__list-img-wrapper">
              <img class="control-panel__list-img" src="<?=HOST?>static/img/control-panel/book.svg" alt="icon">
            </div>
            Категории
        ...
        <li class="control-panel__list-item">
          <a class="control-panel__list-link" href="#">
            <div class="control-panel__list-img-wrapper">
              <img class="control-panel__list-img" src="<?=HOST?>static/img/control-panel/portfolio.svg" alt="icon" />
            </div>
            Портфолио
          </a>
        </li>
        <li class="control-panel__list-item"><a class="control-panel__list-link" href="#">
            <div class="control-panel__list-img-wrapper">
              <img class="control-panel__list-img" src="<?=HOST?>static/img/control-panel/file.svg" alt="icon" />
            </div>
            Страницы
          </a>
        </li>
        ...
        <li class="control-panel__list-item">
          <a class="control-panel__list-link" href="#">
            <div class="control-panel__list-img-wrapper">
              <img class="control-panel__list-img" src="<?=HOST?>static/img/control-panel/message.svg" alt="icon" />
