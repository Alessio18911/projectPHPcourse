...
<div class="page-post__comments-post-comment">
  <div class="post-comment">
    ...
    <form class="post-comment__form" action="<?=HOST?>single-post/<?=$uri_get?>" method="POST">
      <div class="post-comment__form-textarea">
        <textarea class="textarea" placeholder="Введите ваш комментарий..." name="user_comment"><?=$user_comment?></textarea>
      </div>
